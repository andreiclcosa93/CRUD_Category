<section class="top-image">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <img src="{{ asset('front/assets/images/top-image.jpg') }}" alt="">
  ...
  <section class="left-image">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6">
          <img src="{{ asset('front/assets/images/left-image.jpg') }}" alt="">
        </div>
        <div class="col-md-6">
  ...
  <section class="right-image">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-md-6">
          <img src="{{ asset('front/assets/images/right-image.jpg') }}" alt="">
        </div>
      </div>
    </div>
  </section>
